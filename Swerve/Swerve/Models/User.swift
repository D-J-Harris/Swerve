...
class User: Codable {
    ...
    init?(snapshot: DataSnapshot) {
        guard let dict = snapshot.value as? [String : Any],
            ...
            let sendID = dict["sendID"] as? String,
            let matchedSpotifyID = dict["matchedSpotifyID"] as? String,
        ...
        self.sendID = sendID
        self.matchedSpotifyID = matchedSpotifyID
